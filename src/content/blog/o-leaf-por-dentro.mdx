export const meta = {
  ...
  description:
    "Como o Leaf ficou depois da revisão de agosto: tipos, imutabilidade, self obrigatório, traits com implementação default, Default como trait — e as cinco palavras-chave que eu tirei da linguagem.",
  date: "2026-08-12",
